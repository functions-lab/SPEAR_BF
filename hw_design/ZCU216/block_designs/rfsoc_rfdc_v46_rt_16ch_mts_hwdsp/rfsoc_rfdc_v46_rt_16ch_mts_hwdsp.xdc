...
set_property IOSTANDARD LVDS_25 [get_ports {PL_SYSREF_clk_n[0]}]
set_property PACKAGE_PIN E11 [get_ports {PL_SYSREF_clk_p[0]}]
set_property PACKAGE_PIN D11 [get_ports {PL_SYSREF_clk_n[0]}]
...
set_property PACKAGE_PIN E9 [get_ports {PL_CLK_clk_n[0]}]
...
set_input_delay -clock [get_clocks PL_CLK_clk] -min -add_delay 2.100 [get_ports PL_SYSREF_clk_p]
set_input_delay -clock [get_clocks PL_CLK_clk] -max -add_delay 2.300 [get_ports PL_SYSREF_clk_p]

set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {rfsoc_rfdc_v46_rt_16ch_mts_hwdsp_i/MTS_block/IBUFDS_PL_CLK/U0/USE_IBUFDS.GEN_IBUFDS[0].IBUFDS_I/O}]
set_property CLOCK_DEDICATED_ROUTE ANY_CMT_COLUMN [get_nets {rfsoc_rfdc_v46_rt_16ch_mts_hwdsp_i/MTS_block/BUFG_PL_CLK/U0/BUFG_O[0]}]